...
`rpyANTs` was detached from a `RAVE` ([Reproducible Analysis and Visualization of `iEEG`](https://openwetware.org/wiki/RAVE)) module. It is now a standalone package that connects `ANTsPy` with R using seamless shared-memory. 
